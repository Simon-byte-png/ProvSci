...
def mine_candidates(document: Any, strategy: str = "result_focused") -> list[Any]:
    ...
    from .miner import is_core_result_candidate, is_result_paragraph, mine_figure_numeric_candidates, mine_numeric_table_candidates, mine_numeric_text_candidates, mine_text_relations
